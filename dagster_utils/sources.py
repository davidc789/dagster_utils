...
def parse_el_model(dct: dict[str, Any]) -> _ObservableSourceAsset | SourceAsset:
    ...
    return dg.observable_source_asset(
        ...
        key_prefix=source_object.key_prefix,
        description=source_object.description,
        group_name=source_object.group_name,
        # io_manager_key=source_object.io_manager_key,
        # io_manager_def=source_object.io_manager_def,
        # required_resource_keys=source_object.required_resource_keys,
        # resource_defs=source_object.resource_defs,
        # partitions_def=source_object.partitions_def,
